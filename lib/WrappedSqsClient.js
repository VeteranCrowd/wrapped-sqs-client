...
export class WrappedSqsClient {
   ...
   * @param {string} [message.Body] - Stringified message body.
   * @param {string} [message.MessageAttributes] - Encoded message attributes.
  ...
  static decodeMessage({
    ...
    return {
      messageId,
      body,
      attributes: WrappedSqsClient.decodeMessageAttributes(MessageAttributes),
    };
  }
